...
namespace alge
{
	...
	public:
		...
		inline matrix<uint8_t, thisTransposed, thisContiguous && !thisTransposed> row(size_t);

		inline matrix<uint8_t, thisTransposed, thisContiguous&& thisTransposed> col(size_t);
		...
		inline void insert(std::initializer_list<uint8_t>, size_t);

		inline void insert(vector<uint8_t>&, size_t);

		template<bool otherTransposed, bool otherContiguous>
		inline void insert(matrix<uint8_t, otherTransposed, otherContiguous>&, size_t);
