...
#include "../vector/vectorUint64_t.h"
#include "../vector/vectorInt.h"
#include "../vector/vectorUint8_t.h"
...
#define _mm256_abs_pd(a) _mm256_andnot_pd(mask, (a))
		...
		inline std::conditional<axis == 'a', double, vector<double>>::type mean();
		...
		template<char axis = 'a'>
		inline std::conditional<axis == 'a', double, vector<double>>::type sum();
		...
		template<char axis = 'a'>
		inline std::conditional<axis == 'a', double, vector<double>>::type std(double ddof = 0.0, double* mean = nullptr);
		...
		template<char axis = 'a'>
		inline std::conditional<axis == 'a', double, vector<double>>::type min();
		...
		template<char axis = 'a'>
		inline std::conditional<axis == 'a', double, vector<double>>::type argmin(size_t* row = nullptr, size_t* col = nullptr);
		...
		template<char axis = 'a'>
		inline std::conditional<axis == 'a', double, vector<double>>::type max();
		...
		template<char axis = 'a'>
		inline std::conditional<axis == 'a', double, vector<double>>::type argmax(size_t* row = nullptr, size_t* col = nullptr);
