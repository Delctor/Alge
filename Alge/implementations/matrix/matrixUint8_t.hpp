...
namespace alge
{
	...
	inline matrix<uint8_t, thisTransposed, thisContiguous>::matrix(std::initializer_list<std::initializer_list<double>> list)
	{
		...
		this->transposed = thisTransposed;
	...
	template <bool thisTransposed, bool thisContiguous>
	inline matrix<uint8_t, thisTransposed, thisContiguous && !thisTransposed> matrix<uint8_t, thisTransposed, thisContiguous>::row(size_t row)
	{
		if constexpr (thisTransposed)
		{
			return matrix<uint8_t, true, false>(
				&this->_data[row],
				1,
				this->_cols,
				this->actualRows,
	...
	template <bool thisTransposed, bool thisContiguous>
	inline matrix<uint8_t, thisTransposed, thisContiguous&& thisTransposed> matrix<uint8_t, thisTransposed, thisContiguous>::col(size_t col)
	{
		if constexpr (thisTransposed)
		{
		...
		{
			return matrix<uint8_t, false, false>(
				&this->_data[col],
				this->_rows,
				1,
				this->actualRows,
	...
	template <bool thisTransposed, bool thisContiguous>
	inline void matrix<uint8_t, thisTransposed, thisContiguous>::insert(std::initializer_list<uint8_t> list, size_t index)
	{
		if constexpr (thisTransposed)
		{
#ifdef _DEBUG
		...
		else
		{
			...
			if (this->_capacityRows >= newRows)
			{
				uint8_t* tmp = new uint8_t[this->_cols];
				uint8_t* tmp2 = new uint8_t[this->_cols];
	...
	template <bool thisTransposed, bool thisContiguous>
	inline void matrix<uint8_t, thisTransposed, thisContiguous>::insert(vector<uint8_t>& vector1, size_t index)
	{
		if constexpr (thisTransposed)
		{
#ifdef _DEBUG
	...
	template <bool thisTransposed, bool thisContiguous>
	template<bool otherTransposed, bool otherContiguous>
	inline void matrix<uint8_t, thisTransposed, thisContiguous>::insert(matrix<uint8_t, otherTransposed, otherContiguous>& matrix1, size_t index)
	{
		if constexpr (thisTransposed)
		{
#ifdef _DEBUG
