...
namespace alge
{
	...
	inline vector<double> kernelDensity(matrix<double, false, matrix1Contiguous>& samples, matrix<double, false, matrix2Contiguous>& x, double bandwidth = 1.0)
	{
	...
	template<bool matrix1Contiguous, bool matrix2Contiguous>
	inline vector<float> kernelDensity(matrix<float, false, matrix1Contiguous>& samples, matrix<float, false, matrix2Contiguous>& x, float bandwidth = 1.0f)
	{
